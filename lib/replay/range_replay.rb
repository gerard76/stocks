class RangeReplay
  ...
  attr_accessor :stocks, :cash, :from, :till, :current_quote, :current_signal, :quotes, :signals
  
  # stats
  attr_accessor :buy_count, :sell_count, :max, :min, :last_buy_price
  
  def initialize(quotes, signals, from, till)
  ...
  def run
    quotes.each_with_index  do |quote, index|
      ...
      self.current_signal = signals[index]
